...
public class DownLoadLevelTempUtils extends BaseDownLoadUtils{

    public DownLoadLevelTempUtils(BaseGame game, int levelPath, String version , Runnable successRunnable, Runnable retryOutTimesRunnable){
        super(game,successRunnable,retryOutTimesRunnable);
        this.levelPath = levelPath;
        pre = "downloadtemplevel/";

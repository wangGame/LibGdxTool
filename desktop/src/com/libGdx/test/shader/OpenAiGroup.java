...
public class OpenAiGroup extends Image {
    ...
    public OpenAiGroup() {
        ...
        shader = new ShaderProgram(
                Gdx.files.internal("shader/openai/xxx.v"),
                Gdx.files.internal("shader/openai/yyy.f")
        );
    ...
    public void draw(Batch batch, float parentAlpha) {
        ...
        shader.setUniformf("u_resolution", getWidth(), getHeight());

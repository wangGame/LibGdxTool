package com.libGdx.test.ai.tetris;

import com.libGdx.test.ai.tetris.dqn.TetrisEvn;
...
public class App {
    ...
    public static void running() throws IOException {
        ...
        SimpleToy mdp = new SimpleToy(10);

        //define the training method
        QLearningDiscreteDense<SimpleToyState> dql =
                new QLearningDiscreteDense<SimpleToyState>(mdp, DQN_NET, QL_CONFIG, manager);

        //start the training
        dql.train();

        //get the final policy
        DQNPolicy<SimpleToyState> policy = dql.getPolicy();

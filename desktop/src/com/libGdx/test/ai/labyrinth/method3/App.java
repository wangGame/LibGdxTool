...
public class App extends LibGdxTestMain {
    ...
    public static void running() throws IOException {
        ...
        GameEnv2 mdp = new GameEnv2();

        //define the training method
        QLearningDiscreteDense<PathState> dql = new QLearningDiscreteDense<PathState>(mdp, DQN_NET, QL_CONFIG, manager);

        //start the training
        dql.train();

        //get the final policy
        DQNPolicy<PathState> policy = dql.getPolicy();

package com.kw.gdx.fontGenerator;
...
public class FontHelper{
    ...
    private static Matrix4 mx4 = new Matrix4(); private static float curHeight; private static float spaceWidth; private static int currentLine;
    ...
    public static void initialize() {
       ...
       private static BitmapFont prepFont(FreeTypeFontGenerator g, float size, boolean isLinearFiltering) {
        ...
        /*  722 */     (font.getData()).markupEnabled = true;
            ...
            /*  725 */       (font.getData()).breakChars = "xxxxxxxxxxx".toCharArray();
